   ...
   <div class="text-center">
    <div class="box box-primary">
      ...
      <div class="form-group row">
        ...
        <div class="col-2">
          <button type="button" class="btn btn-outline-info" id="idConfirm">ID인증</button>
        </div>
      </div>
      ...
      <button type="button" class="btn btn-primary" id="sendFPw">임시비밀번호발송</button>
      </div>
      </form>
      </div>
   </div>
