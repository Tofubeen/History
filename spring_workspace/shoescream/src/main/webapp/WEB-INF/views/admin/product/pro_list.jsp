									...
									<tbody>
										...
										<c:forEach items="${pro_list }" var="productVO">
											<tr>
												...
												<td>
													<a class="move" href="#" data-bno="${productVO.pro_num }"><img src="">${productVO.pro_up_folder }${productVO.pro_img }</a> <!-- 클래스명 move는 제목과 관련 -->
      ...
      $(document).ready(function () {
        ...
        $("#firstCategory").change(function () {
          ...
          $.getJSON(url, function (secondCategoryList) {
            ...
            //밑에 변수가 select태그를 참조하고 있슴
            secondCategory.find("option").remove(); //2차 카테고리의 option 제거
            secondCategory.append("<option value=''> 2차카테고리선택</option>");
