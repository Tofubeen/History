    ...
    <div class="container">
      ...
      <table class="table table-striped">
        ...
        <tbody>
          ...
          <tr>
            <td scope="row"><input type="checkbox" name="cart_code" value="${cartDTO.cart_code}"></td>
            <td>
              <img width="50%" height="50" src="/user/product/imageDisplay?dateFolderName=${cartDTO.pro_up_folder }&fileName=${cartDTO.pro_img}">
            </td>
