...
//		File클래스 : 파일과 폴더관련작업하는 기능
	...
	//파일 삭제
	//String upload : 업로드 폴더명 . servlet- context.xml에 uploadPath been 정보 사용
	//String folder : 날짜폴더명
	//String fileName : 파일명
	public static void deleteFile(String uploadPath, String folderName, String fileName) {

		//File.separatorCher : 배포된 서버의 운영체제에서 사용하는 파일의 영문구분자를 변환
		//예> 윈도우즈:\ 리눅스 : /
		...
		//2) 썸네일 이미지 삭제
		new File((uploadPath +  "s_" + folderName + "\\" + fileName).replace('\\', File.separatorChar)).delete();
