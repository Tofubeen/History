...
<body class="d-flex flex-column h-100">
               ...
               <div class="col-md-12">
                  ...
                  <div class="box box-primary">
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="updateddate" id="updateddate"
                     </div>
                     <div class="box-footer">
                        ...
                        <button type="button" id="btn_bodify" class="btn btn-primary">Modify</button>
   ...
   <%@include file="/WEB-INF/views/comm/plug-in.jsp" %>
      ...
      <script>
         //수정하기
         document.getElementById("btn_bodify").addEventListener("click", fn_modify);
