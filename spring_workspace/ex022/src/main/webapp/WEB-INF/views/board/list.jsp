...
<body class="d-flex flex-column h-100">
                ...
                <table class="table table-bordered">
                  <tbody>
                    ...
                    <c:forEach items="${list }" var="board">
                      <tr>
                        <td>${board.bno }</td>
                        <td><a class="move" href="#" data-bno="/board/get?bno=${board.bno }">${board.title }</a></td>
                        <td>${board.writer }</td>
                        <td>
              ...
              <div class="box-footer clearfix">
                <div class="row">
                  ...
                  <div class="col-6">
                    ...
                    <!-- [이전] 1 2 3 4 5 6 7 [다음] 페이지 이동목적으로 클릭할 때 사용-->
  ...
  <%@include file="/WEB-INF/views/comm/plug-in.jsp" %>
    ...
    <script>
      ...
      //<form id = "actiomForm"> 태그를 참조하여 , 필요한정보를 변경 및사용 
      //페이지번호 클릭시 동작되는 이벤트 설정

      //<a class="movepage">1</a><a>2</a><a>3</a><a>4</a><a>5</a>
      ...
      Array.from(movePages).forEach(function (mv_page) {
        ...
        mv_page.addEventListener("click", function (event) {
          ...
          // console.log("페이지 번호:", event.target.dataset.page); // data-page="1" -> page
